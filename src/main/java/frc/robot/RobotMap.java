...
public class RobotMap {
  ...
  public static final int PLATE_PISTON_DEPLOY = 4;
  public static final int PLATE_PISTON_RETRACT = 5;
  public static final int CLAW_PISTON_DEPLOY = 2;
  public static final int CLAW_PISTON_RETRACT = 3;

  public static final int CARGO_INTAKE = 5;
  public static final int CARGO_INTAKE_SEONDARY=6;
